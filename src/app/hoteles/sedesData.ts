export const sedesData = [
  ...
  { id: 104, name: 'PREFECO Melchor Ocampo', type: 'Sede', direccion: 'PREFECO Melchor Ocampo, Morelia, Michoacán', notas: 'Actividades Academicas', mapQuery: 'Prefeco Melchor Ocampo, Morelia, Michoacan' }
];
